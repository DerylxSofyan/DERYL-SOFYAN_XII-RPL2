...
public class Aplikasi {
    ...
    private static void simpanKontakKeFile() {
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(NAMA_FILE, true))) {
            ...
            System.out.println("Kontak baru berhasil disimpan ke dalam kontak file.");
        } catch (IOException e) {
    ...
    private static boolean kontakAdaDiFile(Kontak kontak) {
        ...
        return false; // Kontak yang tidak ada di dalam file
    }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            scanner.nextLine(); // Membuang newline dgan nextline
            ...
            switch (pilihan) {
                case 1:
                    ...
                    if (!kontakAdaDiDaftar(kontakBaru)) {
                        ...
                        System.out.println("Kontak sudah ada dalam daftar kontak.");
                    }
                    break;
                case 2:
                ...
                case 5:
                    ...
                    break;
                default:
                    System.out.println("Pilihan tidak valid atau salah. Silakan coba kembali");
            }
        } while (pilihan != 5);
    ...
    // Fungsi membaca kontak dari file
    private static void bacaKontakDariFile() {
        ...
        if (file.exists()) {
            try (BufferedReader reader = new BufferedReader(new FileReader(NAMA_FILE))) {
                ...
                System.err.println("Terjadi kesalahan, membaca kontak dari file.");
            }
        }
    }
