        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    System.out.println("====== Kontak sudah berhasil ditambahkan! =====");
                    break;
                case 2:
                    ...
                    for (Kontak kontak : daftarKontak) {
                        if (kontak.getNama().equalsIgnoreCase(namaHapus)) {
                            ...
                            System.out.println("===== Kontak sudah berhasil dihapus!... =====");
                            break;
                        }
                    }
                    break;
                case 3:
                    System.out.print("Masukkan Nomor Telepon yang akan dihapus: ");
                ...
                case 4:
                    ...
                    break;
                case 5:
                    System.out.println("Berhasil, Terima kasih!!!");
                    break;
                default:
                    System.out.println("Pilihan gagal, ayo coba lagi.");
            }
        } while (pilihan != 5);
